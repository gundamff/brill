...
/**
 * 这是一个写死了workID=1的雪花算法 只能用于单节点部署
 * 
 */
@Slf4j
public class SnowFlakeOneUtil {
    ...
    private SnowFlakeOneUtil(long id) {
    ...
    private static SnowFlakeOneUtil flowIdWorker = new SnowFlakeOneUtil(1);

    public static SnowFlakeOneUtil getFlowIdInstance() {
        return flowIdWorker;
    }
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            SnowFlakeOneUtil snowFlakeUtil = SnowFlakeOneUtil.getFlowIdInstance();
