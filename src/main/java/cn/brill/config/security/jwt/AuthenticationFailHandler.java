...
import cn.brill.common.exception.LoginFailLimitException;
...
public class AuthenticationFailHandler extends SimpleUrlAuthenticationFailureHandler {
        ...
        if (e instanceof UsernameNotFoundException || e instanceof BadCredentialsException) {
            ...
            if (restLoginTime <= 3 && restLoginTime > 0) {
                ...
                ResponseUtil.out(response,
                    ResponseUtil.resultMap(false, 500, "登录错误次数超过限制，请" + tokenProperties.getLoginAfterTime() + "分钟后再试"));
            } else {
    ...
    public boolean recordLoginTime(String username) {
        ...
        redisTemplate.opsForValue().set(key, String.valueOf(loginFailTime), tokenProperties.getLoginAfterTime(),
            TimeUnit.MINUTES);
